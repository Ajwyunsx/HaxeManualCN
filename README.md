...
> **本文档由 [Docsify](https://docsify.js.org/#/) 生成，目前处于文本修缮的阶段,也基于mdui创建，修缮进度可在 [Trello](https://trello.com/b/4HZ6nxeL/haxe-manual-cn) 上查看，囿于个人业余时间精力有限，如果有兴趣加快本文档建设的朋友可以从右上角的 Github 链接处查看协作方式。**
